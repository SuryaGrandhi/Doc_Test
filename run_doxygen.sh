...
sed -e 's/ROCSPARSE_EXPORT//g' ROCm_Libraries/rocSPARSE/src/rocsparse-functions.h > ROCm_Libraries/rocSPARSE/src/rocsparse-functions_sed.h
...
sed -e 's/HSA_API //g' ROCm_API_References/ROCr/src/rocfft.h > ROCm_Libraries/rocFFT/src/rocfft_sed.h
