...
sed -e 's/\\f\$//g' ROCm_Libraries/rocSPARSE/src/rocsparse-functions_sed1.h > ROCm_Libraries/rocSPARSE/src/rocsparse-functions_sed2.h
sed -e 's/\\alpha/alpha/g;s/\\beta/beta/g;s/\\times/X/g;s/\\cdot/\./g;s/\\approx/approx/g;' ROCm_Libraries/rocSPARSE/src/rocsparse-functions_sed2.h > ROCm_Libraries/rocSPARSE/src/rocsparse-functions_sed.h
